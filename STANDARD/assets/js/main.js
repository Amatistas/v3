...
app.run(['$rootScope', '$state', '$stateParams', '$trace',
    function($rootScope, $state, $stateParams, $trace) {
        ...
        $rootScope.app = {
            name: 'NUBEFA', // name of your project
            author: 'NUBEFA INC', // author's name or company name
            description: 'Sistema Administrativo', // brief description
       ...
       if(sessionStorage.getItem('datos')){
        var credential =  JSON.parse(sessionStorage.getItem('datos'));
       }else{
           var credential = {
               "usu_nom":"Usuario"
           }
