...
app.controller('SelectCtrl', [
    ...
    '$rootScope',
    'toaster',
    function($scope, $http, $timeout, $rootScope, toaster) {
        ...
        $scope.productosGetAsyncronicTransladoAlmacen = function(val) {
            if (val.length >= 3) {
                $scope.productosData = [];
                $http
                    .post(
                    ...
                    .then(function(response) {
                        ...
                        angular.forEach(product, function(val, i) {
                            var newItem = {
                                id_pro_tras: val.pro_id,
                                cd_des: val.pro_nom,
                                cantidad: 1,
                                presentacion: val.pst_id
                            };
                            $scope.productosData.push(newItem);
                        });
                    });
        ...
        $scope.productosVentasGetAsyncronic = function(val) {
            if (val.length >= 3) {
                $scope.productosData = [];
                $http
                    .post(
                    ...
                    .then(function(response) {
                        ...
                        angular.forEach(product, function(val, i) {
                            var newItem = {
                                //importantes para venta_det
                                vd_pro_id: val.pro_id,
                                pro_tip: val.pro_tip,
                                vd_can: 1,
                                pst_id: val.pst_id,
                                vd_bar: val.pro_bar,
                                //datos q van a modificarse con la lista de precio
                                vd_fac: val.pro_fac,
                                vd_pre: val.pro_pre,
                                //importantes para interface
                                pro_pad: val.pad,
                                det_vd_id: val.pro_id,
                                pro_cod: val.pro_cod,
                                cd_des: val.pro_nom,
                                cd_pre: 0,
                                cd_igv: val.pro_igv,
        ...
        $scope.productosGetAsyncronicListPrecio = function(val) {
            $scope.productosData = [];
            if (val.length >= 3) {
                    ...
                    .then(function(response) {
                        ...
                        angular.forEach(product, function(val, i) {
                            var newItem = {
                                ...
                                falso_monto: 0,
                                lpd_com: val.pro_pre,
                                lpd_porcentaje_igv: 18, //igv
                                lpd_valor_igv: 0, //igv
                                lp_id: 0,
                                lpd_uti: 0,
                                lpd_vpre: 0, //precio sin igv
                                lpd_pre: 0 //total
                            };
                            $scope.productosData.push(newItem);
                        });
                ...
                $http
                    .post(
                        `../../../../api/mantenimiento/mantenimiento/search2.php?getdb=${JSON.parse(
								$rootScope.d.datos
							).database}&tbnom=getproductoguiaremision&s=${val}&key=pro_nom&where=alm_id&igual=${alm}`
                    )
                    .then(function(response) {
                        var product = response.data.data;
                        angular.forEach(product, function(val, i) {
        ...
        $scope.ubigeoGetAsyncronic = function(val) {
            if (val.length >= 3) {
                $scope.ubigeoList = [];
                $http
                    .post(
                        `../../../../api/mantenimiento/mantenimiento/search.php?getdb=${JSON.parse($rootScope.d.datos)
							.database}&tbnom=getubigeo&s=ubi&key=${val}`
                    )
                    .then(function(response) {
                        $scope.ubigeoList.push(response.data.data);
                    });
            } else {
                return false;
            }
        ...
        $scope.proveedoresGetAsyncronic = function(val) {
            if (val.length >= 3) {
                ...
                $http
                    .post(
                        `../../../../api/mantenimiento/mantenimiento/search.php?getdb=${JSON.parse($rootScope.d.datos)
							.database}&tbnom=getproveedores&s=ane_alias&key=${val}`
                    )
                    .then(function(response) {
                        $scope.proveedoresList.push(response.data.data);
                    });
        ...
        $scope.clientesGetAsyncronic = function(val) {
            if (val.length >= 3) {
                $scope.proveedoresList = [];
                $http
                    .post(
                        `../../../../api/mantenimiento/mantenimiento/search.php?getdb=${JSON.parse($rootScope.d.datos)
							.database}&tbnom=getclientes&s=ane_alias&key=${val}`
                    )
                    .then(function(response) {
                        $scope.proveedoresList.push(response.data.data);
                    });
